        ...
        @endif
                ...
                <form method="POST" action="{{ route('comments.update' ,$comment -> id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="name" value="{{ $comment->name }}" id="" aria-describedby="">
                        @error('name')
                    ...
                    <button type="submit" class="btn btn-primary">{{ __('message.commentSubmitBtn') }}</button>
